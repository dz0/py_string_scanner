...
with open('found_strings.json', 'w') as f:    json.dump(FOUND_STR, f, indent=4)
with open('skipped_strings.json', 'w') as f:    json.dump(SKIPPED_STR, f, indent=4)
